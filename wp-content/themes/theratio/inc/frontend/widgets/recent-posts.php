...
class theratio_recent_news extends WP_Widget {
    ...
    function __construct() {
        ...
        parent::__construct(
            ...
            esc_html__('OT Recent Posts', 'theratio'), 

            // Widget description
            array( 'description' => esc_html__( 'OT Recent Posts', 'theratio' ), ) 
        );
    }
    ...
    public function widget( $args, $instance ) {
        ...
        $title = apply_filters( 'widget_title', empty( $instance['title'] ) ? esc_html__( 'Latest News', 'theratio' ) : $instance['title'], $instance, $this->id_base );
    ...
    // Check values
    	 ...
    	 $title = isset( $instance['title'] ) ? $instance['title'] : esc_html( 'Latest News', 'theratio' );
    ...
    <p>
        <label><?php esc_html_e( 'Title:', 'theratio' ); ?></label>

        <input class="widefat" id="<?php echo esc_attr($this->get_field_id('title')); ?>" name="<?php echo esc_attr($this->get_field_name('title')); ?>" type="text" value="<?php echo esc_attr($title); ?>" />
    </p>
    <p>

        <label><?php esc_html_e( 'Number of posts to show:', 'theratio' ); ?></label> 
    ...
    <p>
        <label>
            ...
            <?php esc_html_e( 'Show date time', 'theratio' ); ?>
        </label>
    </p>
...
function theratio_wpb_recent_news() {
	register_widget( 'theratio_recent_news' );
}
add_action( 'widgets_init', 'theratio_wpb_recent_news' );